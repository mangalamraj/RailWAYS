            ...
            <div className={styles.signupParent}>
                    ...
                    <div>
                        <form action="POST" onSubmit={onsubmit}>
                            ...
                            <div><input placeholder="Email" type="text" value={email} onChange={HandleEmailChange}></input></div>
                            
                            <div><input placeholder="Password" type="text" value={password} onChange={HandlePasswordChange}></input></div>
